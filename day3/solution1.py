"""Solution to day 3, part 1 puzzle on adventofcode.com"""
...
def main_logic(input_data: str) -> int:
    """Main logic for the puzzle. We need to find the sum of all gear parts."""
    text_as_array = make_array(input_data=input_data)
                ...
                for neighbour_coord in neighbour_coords:
                    ...
                    if val in digits:
                        ...
                        if connected_val not in used_list:
                            answer = answer + int(connected_val)
...
def solve_puzzle() -> None:
    ...
    # Get the input data
    input_data = get_input(filepath="/Users/bryan/aoc/day3/input.txt")
